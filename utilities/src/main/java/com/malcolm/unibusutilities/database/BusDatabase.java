...
public abstract class BusDatabase extends RoomDatabase {
    ...
    private static final Migration defaultMigration = new Migration(5, 6) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {

        }
    };
    private static final Migration enhancedMigrationHoliday = new Migration(4, 6) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {
    ...
    private static final Migration enhancedMigrationWednesday = new Migration(4, 6) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            database.execSQL("ALTER TABLE \"Timetable\" RENAME TO 'Timetable_Old';\n");
            database.execSQL("CREATE TABLE \"Timetable\" (\n" +
    ...
    private static final Migration enhancedMigrationNormal = new Migration(4, 6) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            database.execSQL("ALTER TABLE \"Timetable\" RENAME TO 'Timetable_Old';\n");
            database.execSQL("CREATE TABLE \"Timetable\" (\n" +
    ...
    private static final Migration enhancedMigrationWeekend = new Migration(4, 6) {
        @Override
        public void migrate(@NonNull SupportSQLiteDatabase database) {
            database.execSQL("ALTER TABLE \"Timetable\" RENAME TO 'Timetable_Old';\n");
            database.execSQL("CREATE TABLE \"Timetable\" (\n" +
    ...
    private static BusDatabase createRoomDatabase(Context context){
        ...
        switch (DB_NAME) {
            ...
            case DB_WEEKDAY_NAME:
                builder.addMigrations(enhancedMigrationNormal);
                break;
            case DB_WEEKDAY_WED_NAME:
                builder.addMigrations(enhancedMigrationWednesday);
                break;
